          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              ...
              <span className="text-sm font-medium tracking-wide text-blue-200">
                Welcome to Aion Institute of Management Studies (AIMS)
              </span>
            </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600">
              Discover what makes AIMS a premier destination for higher education and professional growth.
            </p>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-8">
            ...
            >
              ...
              <div className="rounded-2xl bg-white p-8 shadow-sm border border-slate-100">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Beyond education, AIMS focuses on technological innovation and recruitment. We partner with top banks, IT firms, and manufacturing giants to provide unparalleled placement opportunities for our graduates.
                </p>
              </div>
            </motion.div>
