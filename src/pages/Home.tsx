      ...
      <section className="relative flex min-h-[90vh] items-center justify-center overflow-hidden bg-slate-950 py-20 lg:py-32">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              Aion Tech Career offers world-class education, cutting-edge research, and guaranteed placement opportunities in top-tier companies.
            </motion.p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600">
              Discover what makes Aion Tech Career a premier destination for higher education and professional growth.
            </p>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-8">
            ...
            >
              <div className="rounded-2xl bg-white p-8 shadow-sm border border-slate-100">
                ...
                <h3 className="mb-3 text-2xl font-bold text-slate-900">About Aion Tech Career</h3>
                <p className="text-slate-600 leading-relaxed">
                  Aion Tech Career is dedicated to providing excellence in education. Our curriculum is designed by industry experts to bridge the gap between academic learning and corporate requirements, ensuring our students are industry-ready from day one.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-white p-8 shadow-sm border border-slate-100">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Beyond education, Aion Tech Career focuses on technological innovation and recruitment. We partner with top banks, IT firms, and manufacturing giants to provide unparalleled placement opportunities for our graduates.
                </p>
              </div>
            </motion.div>
